...
@section('content')
    ...
    <div class="card text-center">
        ...
        <div class="card-body" id="comprof" align="left">
            ...
            <img class="img-fluid" id="logo" style="height:150px; margin-top:10px; overflow: hidden;" src="{{ asset('/img/pizza.svg') }}" alt="Logo cannot be found">
            <hr/>
        ...
        <div class="card-body" id="menuove" align="left">
            ...
            <div class="card flex-row flex-wrap">
                <div class="card-header border-0" style=" width: 200px; height: 200px;">
                    <img src="{{ asset('/img/pizza1.jpg') }}" style="width: 100%;height: 100%;" alt="">
                </div>
